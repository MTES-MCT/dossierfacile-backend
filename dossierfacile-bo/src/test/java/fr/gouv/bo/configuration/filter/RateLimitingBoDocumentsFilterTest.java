...
class RateLimitingBoDocumentsFilterTest {
    ...
    private RateLimitingBoDocumentsFilter filterWith(int perMinute, int perDay) {
        RateLimitingBoDocumentsFilter filter = new RateLimitingBoDocumentsFilter();
    ...
    void requestsWithinPerMinuteLimitPassThrough() throws Exception {
        RateLimitingBoDocumentsFilter filter = filterWith(2, 100);
    ...
    void requestExceedingPerDayLimitReturns429() throws Exception {
        ...
        RateLimitingBoDocumentsFilter filter = filterWith(100, 3);
    ...
    void differentIpsHaveIndependentBuckets() throws Exception {
        RateLimitingBoDocumentsFilter filter = filterWith(1, 100);

        MockHttpServletRequest requestIp1 = requestFromIp("10.2.1.1");
        MockHttpServletRequest requestIp2 = requestFromIp("10.2.1.2");
    ...
    void requestWithoutForwardedForHeaderUsesRemoteAddr() throws Exception {
        RateLimitingBoDocumentsFilter filter = filterWith(1, 100);
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.setRemoteAddr("172.31.0.5");
