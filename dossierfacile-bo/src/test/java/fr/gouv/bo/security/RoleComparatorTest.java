...
class RoleComparatorTest {
    ...
    private RoleHierarchy getRoleHierarchy() {
        var config = new RoleHierarchyConfig();
        return config.roleHierarchy();
    }

    @Test
    void highest_is_admin_when_admin_present() {
        RoleService comparator = new RoleService(getRoleHierarchy());
    ...
    void ge_true_when_userRole_implies_target() {
        ...
        assertThat(comparator.isRoleGreaterOrEqual(Role.ROLE_SUPPORT, Role.ROLE_OPERATOR)).isTrue();
    }
    ...
    void ge_false_when_lower_than_target() {
        ...
        assertThat(comparator.isRoleGreaterOrEqual(Role.ROLE_OPERATOR, Role.ROLE_SUPPORT)).isFalse();
    }
