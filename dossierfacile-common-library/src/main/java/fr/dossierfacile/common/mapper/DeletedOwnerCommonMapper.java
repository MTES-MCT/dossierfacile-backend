...
import fr.dossierfacile.common.model.apartment_sharing.DeletedOwnerModel;
...
public interface DeletedOwnerCommonMapper {
    ...
    public abstract DeletedOwnerModel toDeletedOwnerModel(Owner owner);
