$(document).ready(function () {
    ...
    $(".switch-toggle input").click('change', function (e){
    ...
    $('.example').click(function(){
        ...
        {$('.tooltip_example').show();
            setTimeout(function(){ $('.tooltip_example').hide(); }, 10000);}
        else
    ...
    $(".tr-property-table").click(function (e) {
        ...
        if( count === 1 && arraySave[0] !== actual && arraySave[0] !== undefined){
            count = 0;
            $('#row-show-details' + arraySave[0]).removeClass('selected-prospect');
            $('#details' + arraySave[0]).addClass('hidden');
            $('#details' + actual).removeClass('hidden');
            $('#row-show-details' + actual).addClass('selected-prospect');
            arraySave[0] = actual;
            arraySave[2] = 1;
            return;
        }

        if(count === 1 && arraySave[1] !== undefined && arraySave[1] === 1){
            $('#row-show-details' + arraySave[0]).removeClass('selected-prospect');
            $('#details' + arraySave[0]).addClass('hidden')
            arraySave[1] = undefined;
            count = 0;
            return;
        }

        if( count === 2 && arraySave[0] === actual){
            arraySave[0] = undefined;
            count = 0;
            $('#row-show-details' + prospectId).removeClass('selected-prospect');
            $('#details' + prospectId).addClass('hidden')
            return;
        }

        if(count === 1 && arraySave[2] === 1 && arraySave[2] !== undefined) {
            arraySave[2] = undefined;
            arraySave[0] = undefined;
            count = 0;
            $('#row-show-details' + prospectId).removeClass('selected-prospect');
            $('#details' + prospectId).addClass('hidden')
        ...
        if( count === 1 ){
            $('#row-show-details' + prospectId).addClass('selected-prospect');
            $('#details' + prospectId).removeClass('hidden')
            arraySave[0] = prospectId;
            return;
        }
    ...
    hideCookies = function() {
        $("#cookie").fadeOut('slow');
        document.cookie = "hideCookie=true; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/";
    }
    ...
    launchAnalytics = function() {
        ...
        gtag('js', new Date());
        gtag('config', 'UA-50823626-2');
    }

    if (document.cookie.indexOf("hideCookie=true") < 0) {
        $("#cookie").fadeIn('slow');
    }
    if (document.cookie.indexOf("allowCookie=true") >= 0) {
        launchAnalytics();
    }
    ...
    $("#allowCookie").click(function () {
        hideCookies();
        document.cookie = "allowCookie=true; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/";
        launchAnalytics();
    });
