...
class MonFranceConnectAuthenticationRequestTest {
    ...
    void should_build_uri_to_call() {
        MonFranceConnectAuthenticationRequest request = MonFranceConnectAuthenticationRequest.forDocumentWith(MFC_QR_CODE).get();
    ...
    void should_not_build_request_if_the_qr_code_is_not_from_MonFranceConnect(String qrCodeContent) {
        ...
        assertThat(MonFranceConnectAuthenticationRequest.forDocumentWith(qrCode)).isEmpty();
    }
