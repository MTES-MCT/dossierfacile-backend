...
class TwoDDocFinderTest {
    ...
    void should_find_2DDoc_on_pdf_regardless_of_text_direction(int page) throws IOException {
        ...
        Optional<TwoDDocRawContent> twoDDoc = TwoDDocFinder.on(document, page).find2DDoc();
    ...
    void should_return_empty_if_no_2DDoc_found(String fileName) throws IOException {
        ...
        Optional<TwoDDocRawContent> twoDDoc = TwoDDocFinder.on(document).find2DDoc();
