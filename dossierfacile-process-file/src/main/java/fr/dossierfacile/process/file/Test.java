...
public class Test {
    ...
    private static void showMatchIntensity( GrayF32 image, GrayF32 template, GrayF32 mask ) {
        ...
        UtilImageIO.saveImage(output, "/Users/nsagon/TestDataMatrix/match_intensity.png");
    }

    public static void main( String[] args ) {
        // Load image and templates
        String directory = "/Users/nsagon/TestDataMatrix/";

        GrayF32 image = UtilImageIO.loadImage(directory, "2ddoc.jpg", GrayF32.class);
        GrayF32 templateCursor = UtilImageIO.loadImage(directory, "template_2d_doc.png", GrayF32.class);
        GrayF32 mask = UtilImageIO.loadImage(directory, "mask_2d_doc.png", GrayF32.class);
        ...
        drawRectangles(g2, image, templateCursor, mask, 1);
        // show match intensity image for this template
        showMatchIntensity(image, templateCursor, mask);

        UtilImageIO.saveImage(output, "/Users/nsagon/TestDataMatrix/result.png");
    }
