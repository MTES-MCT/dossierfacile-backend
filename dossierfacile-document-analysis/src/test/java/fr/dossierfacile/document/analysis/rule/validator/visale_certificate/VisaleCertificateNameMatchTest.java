...
class VisaleCertificateNameMatchTest {
    ...
    private GenericProperty buildBeneficiaire(String nom, String prenoms) {
    ...
    private Document documentWithCouple(String tenant1FirstName, String tenant1LastName,
                                         String tenant2FirstName, String tenant2LastName,
    ...
    void passed_when_match_with_accents() {
        DocumentIAFileAnalysis analysis = iaAnalysisWithExtraction(List.of(
                buildBeneficiaire("Müller", "François")
        ));
    ...
    void passed_when_match_among_multiple_beneficiaires() {
        DocumentIAFileAnalysis analysis = iaAnalysisWithExtraction(List.of(
                buildBeneficiaire("Martin", "Sophie"),
                buildBeneficiaire("Dupont", "Jean")
        ));
    ...
    void passed_when_co_tenant_matches() {
        ...
        Document doc = documentWithCouple("Jean", "Dupont", "Sophie", "Martin", analysis);
        RuleValidatorOutput out = validate(doc);
    ...
    void failed_when_no_match_in_couple() {
        DocumentIAFileAnalysis analysis = iaAnalysisWithExtraction(List.of(
                buildBeneficiaire("Durand", "Pierre")
        ));
    ...
    void passed_with_composite_names_and_hyphens() {
        DocumentIAFileAnalysis analysis = iaAnalysisWithExtraction(List.of(
                buildBeneficiaire("De La Cruz", "Jean-Pierre")
        ));
