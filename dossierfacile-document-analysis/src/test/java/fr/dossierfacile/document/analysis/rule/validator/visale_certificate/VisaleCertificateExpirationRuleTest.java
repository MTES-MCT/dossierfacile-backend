...
class VisaleCertificateExpirationRuleTest {
    ...
    void passed_when_expiration_in_future() {
        ...
        Assertions.assertThat(out.rule().getRuleData()).isInstanceOf(VisaleCertificateExpirationRuleData.class);
        VisaleCertificateExpirationRuleData ruleData = (VisaleCertificateExpirationRuleData) out.rule().getRuleData();
        Assertions.assertThat(ruleData.extractedExpirationDate()).isEqualTo(future);
    }
    ...
    void failed_when_expiration_in_past() {
        ...
        Assertions.assertThat(out.rule().getRuleData()).isInstanceOf(VisaleCertificateExpirationRuleData.class);
        VisaleCertificateExpirationRuleData ruleData = (VisaleCertificateExpirationRuleData) out.rule().getRuleData();
        Assertions.assertThat(ruleData.extractedExpirationDate()).isEqualTo(past);
    }
