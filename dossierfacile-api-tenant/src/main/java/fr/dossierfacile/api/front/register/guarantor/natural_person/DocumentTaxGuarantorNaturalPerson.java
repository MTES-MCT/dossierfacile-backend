...
@Slf4j
@Service
public class DocumentTaxGuarantorNaturalPerson extends AbstractDocumentTaxSaveStep<DocumentTaxGuarantorNaturalPersonForm> {

    private final GuarantorRepository guarantorRepository;

    public DocumentTaxGuarantorNaturalPerson(
    ...
    protected DocumentSaveResult saveDocument(Tenant tenant, DocumentTaxGuarantorNaturalPersonForm documentTaxGuarantorNaturalPersonForm) {
        ...
        return processTaxDocument(tenant, document, documentTaxGuarantorNaturalPersonForm, guarantor.getDocuments());
    }
}
