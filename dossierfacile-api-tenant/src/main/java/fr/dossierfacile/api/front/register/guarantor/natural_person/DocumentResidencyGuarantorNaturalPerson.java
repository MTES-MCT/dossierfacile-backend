...
@Service
@AllArgsConstructor
public class DocumentResidencyGuarantorNaturalPerson implements SaveStep<DocumentResidencyGuarantorNaturalPersonForm> {
    ...
    Document saveDocument(Tenant tenant, DocumentResidencyGuarantorNaturalPersonForm documentResidencyGuarantorNaturalPersonForm) {
        ...
        List<MultipartFile> multipartFiles = documentResidencyGuarantorNaturalPersonForm.getDocuments().stream().filter(f -> !f.isEmpty()).collect(Collectors.toList());
